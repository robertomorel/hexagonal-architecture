...
/*
	Irá ser utilizado com o controller
*/
func MakeProductHandlers(r *mux.Router, n *negroni.Negroni, service application.ProductServiceInterface) {
	/*
		O "negroni" é usado para envolver aquilo que vai ser executado
		Isso vai aplicar e gerar log para tudo
	*/
...
func createProduct(service application.ProductServiceInterface) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		// Decoder está sendo utilizado para pegar os dados do body da requisição e decodar no DTO (preenchendo o DTO)
